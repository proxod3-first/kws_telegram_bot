...
API_KEY = os.environ["KWS_BOT"] # your telefram bot api_key
...
После начала записи подождите примерно 0.3 секунды, прежде чем говорить, чтобы начало слова захватилось корректно.\n\n\
